...
<small><i> (*) Cafetaria is closed. You can eat outside RIKEN. Or, we provide a simple delivery from covenient store or supermarket.</i></small>
...
<button onclick="togglePoster()">Show/Hide Venue</button>
...
<script>
    function togglePoster() {
        const posterDiv = document.getElementById('venueDiv');
