...
- <i>Do I need to contact the organizers for registration?</i> <br>  It is not mandatory. You can register via the Google Form without contacting the organizers. However, if you have any questions or need confirmation, you can contact one of the organizers.
 ...
 <div id="participants"></div>
    <script>
        // Data: countries and number of participants
        const participants = [
            { country: "Japan", code: "jp", count: 3 },
            { country: "Germany", code: "de", count: 1 },
            { country: "Indonesia", code: "id", count: 1 },
        ];
        ...
        participants.forEach(participant => {
            // Create a div for each participant
            const participantDiv = document.createElement('div');
            participantDiv.className = 'participant';

            // Add the flag image
            const img = document.createElement('img');
            img.src = `https://flagcdn.com/w40/${participant.code}.png`;
            img.alt = `${participant.country} flag`;
            participantDiv.appendChild(img);

            // Add the number of participants
            const count = document.createElement('p');
            count.textContent = participant.count;
            participantDiv.appendChild(count);

            // Append the participant div to the container
